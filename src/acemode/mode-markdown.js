...
ace.define("ace/mode/markdown2",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/javascript","ace/mode/xml","ace/mode/html","ace/mode/markdown_highlight_rules","ace/mode/folding/markdown","ace/mode/javascript","ace/mode/html","ace/mode/sh","ace/mode/sh","ace/mode/xml","ace/mode/css"], function(require, exports, module) {
"use strict";
...
var Mode = function() {
  ...
  var XmlBehaviour = require("./behaviour/xml").XmlBehaviour;
  console.log('setting xml behaviour XmlMode');
  this.foldungRules = new XmlFoldMode();
  this.$behaviour = new XmlBehaviour();
};
oop.inherits(Mode, TextMode);
...
(function() {
    ...
    this.$id = "ace/mode/markdown2";
    this.snippetFileId = "ace/snippets/markdown";
}).call(Mode.prototype);

exports.Mode = Mode;
});                (function() {
                    ace.require(["ace/mode/markdown2"], function(m) {
